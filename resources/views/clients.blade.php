    ...
    <div class="max-w-screen-xl mx-auto my-24 flex flex-col items-center justify-center">
        <div class="text my-10 pb-5 flex justify-start w-full">
            ...
            <div class="clients-container flex justify-center flex-wrap">
                ...
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/apollo-hospitals-logo.png')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/asian_paints.png')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/bangladesh-bidyut-unnayan-board-logo-BDC2419C55-seeklogo.com.png')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                ...
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/bashundhara-group-vector-logo.png')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                ...
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/british-american-tobacco-logo-24008E435B-seeklogo.com.png')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                ...
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/holcim-logo-png-transparent.png')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                ...
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/linde-logo-png-transparent.png')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                ...
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/nuvista-pharma-limited-bangladesh-logo.png')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/popular.jpg')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/radisson_Blu_logo.svg.png')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                ...
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/Roundel_of_Bangladesh_–_Army_Aviation.svg.png')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/sanofi.png')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/Drug_International_Ltd_logo.png')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/SKF_NEW_LOGO.png')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
                    <img src="{{asset('clients/smc-enterprise-ltd-logo-1813D512EB-seeklogo.com.png')}}" alt="">
                </div>
                <div class="border p-8 flex justify-center items-center flex-auto hover:">
